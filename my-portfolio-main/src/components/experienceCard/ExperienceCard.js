      ...
      <div className={cardClass}>
        <div className="experience-card-header">
          ...
          <div className="experience-card-title-group">
            <h5
              className={
                isDark ? "dark-mode experience-role" : "experience-role"
              }
            >
              {cardInfo.role}
            </h5>
            {cardInfo.companyWebsite ? (
              ...
              <h6
                className={
                  isDark ? "dark-mode experience-company" : "experience-company"
                }
              >
                {cardInfo.company}
              </h6>
            ...
            <p
              className={
                isDark ? "dark-mode experience-duration" : "experience-duration"
              }
            >
              {cardInfo.date}
            </p>
        ...
        <div className="experience-card-body">
          <p
            className={isDark ? "dark-mode experience-desc" : "experience-desc"}
          >
            {cardInfo.desc}
          </p>
