        ...
        <div className="research-detail-container">
          <div className="research-detail-card">
            ...
            <div className="research-detail-content">
              {project.isThesis && <div className="thesis-badge">THESIS</div>}
              <h1 className="detail-title">{project.projectName}</h1>
              {project.publishedAt && (
                <p className="detail-published">{project.publishedAt}</p>
              )}
              <div className="detail-abstract-section">
                <h3 className="section-heading">Abstract</h3>
                <p className="detail-description">{project.projectDesc}</p>
              </div>
